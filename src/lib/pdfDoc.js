...
export function buildHandoverPdf(document, org) {
  ...
  doc.setFontSize(6.5);
  doc.setTextColor(...LIGHT);
  doc.text(`SIMICO OPERATOR · ${document.operator.split(' · ')[0].toUpperCase()}`, MARGIN_X, sigY + 84);
  ...
  doc.setFontSize(7);
  doc.setTextColor(...LIGHT);
  doc.text(`${document.doc} · generated by SIMICO Warehouse Scan`, MARGIN_X, footY);
